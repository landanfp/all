...
API_ID = os.environ.get('API_ID', 'YOUR_API_ID') # <--- مقدار واقعی خود را اینجا قرار دهید
API_HASH = os.environ.get('API_HASH', 'YOUR_API_HASH') # <--- مقدار واقعی خود را اینجا قرار دهید
BOT_TOKEN = os.environ.get('BOT_TOKEN', 'YOUR_BOT_TOKEN') # <--- مقدار واقعی خود را اینجا قرار دهید

...
# --- تابع transformation_matrix (نسخه بهبود یافته برای اطمینان) ---
def transformation_matrix(eye_center_src, eye_center_dst, eye_center_right_src, eye_center_right_dst, scale=1.0):
    ...
    try:
        ...
        # محاسبه محل جدید مرکز چشم مبدا پس از اعمال چرخش و مقیاس توسط M
        # M = [[alpha, beta, tx], [-beta, alpha, ty]]
        ...
        # محاسبه میزان جابجایی (translation) لازم برای انتقال مرکز تبدیل شده مبدا به مرکز مقصد
